...
const stories: Story[] = [
  // BYRON REGION
  { title: 'Le "Byron Bubble" — 3 jours deviennent 3 mois', text: 'Les backpackers appellent ca le "Byron Bubble" : tu arrives pour un weekend de surf et de yoga, et trois mois plus tard tu travailles dans un cafe bio en sarouel. L\'Arts Factory Lodge est le ground zero de ce phenomene — un ancien piggery transforme en village backpacker avec hamacs, tipis et feux de camp.', location: 'Byron Bay — Arts Factory Lodge', region: 'byron', category: 'insolite', image: 'https://upload.wikimedia.org/wikipedia/commons/0/05/2020-12-19_Cape_Byron_Lighthouse.jpg' },
  { title: 'Le water dragon voleur de bacon', text: 'Au petit-dej a l\'Arts Factory, un water dragon (lezard d\'un metre) a saute sur la table d\'un backpacker et lui a vole une tranche de bacon directement de son assiette. Les brush turkeys, eux, viennent gratter dans ton sac a dos des que tu tournes le dos. A Byron, la faune locale n\'a aucun respect pour ton brunch.', location: 'Byron Bay — Arts Factory Lodge', region: 'byron', category: 'rencontre', image: 'https://upload.wikimedia.org/wikipedia/commons/b/b6/AndrewMercerIMG_5585_Australian_Water_Dragon.jpg' },
  { title: 'Sunrise au phare — le vrai hack local', text: 'La majorite des touristes visitent le Cape Byron Lighthouse en plein apres-midi avec mille selfie sticks. Les locaux y vont au lever du soleil : la lumiere est magique, l\'air est frais, et tu as des chances de voir des dauphins ou des baleines depuis le point le plus a l\'est de l\'Australie.', location: 'Byron Bay — Cape Byron Lighthouse', region: 'byron', category: 'astuce', image: 'https://upload.wikimedia.org/wikipedia/commons/0/05/2020-12-19_Cape_Byron_Lighthouse.jpg' },
  ...
  { title: 'Les Bin Chickens — l\'oiseau le plus deteste d\'Australie', text: 'L\'ibis blanc, surnomme "bin chicken" (poulet de poubelle), fouille les poubelles et vole la bouffe des touristes. Depuis 2024, un artiste local a installe plus de 200 sculptures d\'ibis en metal dans Brisbane — certaines tiennent une biere. Le "Bin Chicken Trail" est devenu une attraction touristique officielle.', location: 'Brisbane — partout (Bin Chicken Trail)', region: 'brisbane', category: 'insolite', image: 'https://upload.wikimedia.org/wikipedia/commons/6/60/Threskiornis_molucca_-_Perth.jpg' },
